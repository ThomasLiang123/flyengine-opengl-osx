...
void Model::MakeCube(simd_float4 color) {
    MakeVertex(0, 0, 0);
    MakeVertex(1, 0, 0);
    MakeVertex(0, 1, 0);
    MakeVertex(1, 1, 0);
...
void Model::MakeRect(float w, float l, float h, simd_float4 color) {
    MakeVertex(0, 0, 0);
    MakeVertex(w, 0, 0);
    MakeVertex(0, l, 0);
    MakeVertex(w, l, 0);
...
void Model::MakePlatform(float w, float l, simd_float4 color) {
    MakeVertex(0, 0, 0);
    MakeVertex(w, 0, 0);
    MakeVertex(0, l, 0);
    MakeVertex(w, l, 0);
