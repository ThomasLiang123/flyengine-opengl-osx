...
public:
    ...
    void MakeCube();
    void MakeRect(float w, float l, float h);
    
    void MakeCube(simd_float4 color);
    void MakeRect(float w, float l, float h, simd_float4 color);
    void MakePlatform(float w, float l, simd_float4 color);
    ...
    void ShiftVertices(float dx, float dy, float dz);
    ...
    void SetFaceStart(unsigned long n);
    void SetVertexStart(unsigned long n);
