...
void RenderPipeline::SetBuffers(std::vector<simd_float3> *v, std::vector<Face> *f) {
    vertex_buffer = v;
    face_buffer = f;
}
...
void RenderPipeline::RenderScene() {
    ...
    glLoadIdentity();
    gluPerspective(c->FOV.y*180/M_PI, (GLfloat) window_width / (GLfloat) window_height, 1.f, 100.f);
